import React, { ReactNode } from "react"; // Import ReactNode for type
import {
  FaBold,
  FaUnderline,
  FaItalic,
...
export const INLINE_TYPES: ToolType[] = [
  {
    label: "Underline",
    style: "UNDERLINE",
    icon: <FaUnderline />,
...
export const BLOCK_TYPES: ToolType[] = [
  {
    label: "Header",
    style: "header-three",
    icon: <FaHeading />,
...
export const ENTITY_TYPES: ToolType[] = [
  // {
  //   label: "Link",
