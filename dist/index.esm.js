...
function addDefaultProps(defaultProps, props) {
  ...
  var result = _objectSpread$2({}, props);
...
var propTypes$2 = _objectSpread$1(_objectSpread$1({}, Transition.propTypes), {}, {
...
var defaultProps = _objectSpread$1(_objectSpread$1({}, Transition.defaultProps), {}, {
...
function Fade(props) {
  ...
  return /*#__PURE__*/React.createElement(Transition, _extends$2({
    nodeRef: innerRef
...
var CardBase = function (props) {
    return (React.createElement(Card, __assign({ className: classNames(props.className, {
...
export { AlertBase as Alert, CardBase as Card };
